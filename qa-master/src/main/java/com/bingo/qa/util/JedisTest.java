...
//        JedisShardInfo shardInfo = new JedisShardInfo("redis://localhost:6379/0");//这里是连接的本地地址和端口
...
//        URI uri = URI.create("redis://localhost:6379/0/123456");
//        System.out.println("uri"+" "+uri);
//        System.out.println(JedisURIHelper.isValid(uri));
